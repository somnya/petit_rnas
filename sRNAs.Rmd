...
plot(simulateResiduals(glmmTMB(log2(ptgs+1) ~ sex * bias + (1|gene), data = temp)))
plot(simulateResiduals(glmmTMB(round(rddm) ~ sex * bias + (1|gene) + (1|tissue), dispformula =~ 1, family=nbinom1, data = exp_all)))
rm(temp)
```
